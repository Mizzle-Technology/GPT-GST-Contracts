...
contract RewardDistributionTest is Test {
    ...
    event RewardsClaimed(address indexed shareholder, uint256 amount, address indexed token, bytes32 distributionId);
    ...
    function test_updateShareholderShares_remove_shareholder() public {
        ...
        assertFalse(
            rewardDistribution.hasRole(ADMIN_ROLE, shareholder1), "Shareholder should no longer have ADMIN_ROLE"
        );
    }
    ...
    function test_addRewardToken_success() public {
        ...
        assertTrue(rewardDistribution.supportTokens(address(rewardToken1)), "Token should be supported");
        assertTrue(rewardDistribution.isRewardToken(address(rewardToken1)), "Token should be in rewardTokens set");
    }
    ...
    function test_removeRewardToken_success() public {
        ...
        assertFalse(rewardDistribution.supportTokens(address(rewardToken1)), "Token should not be supported");
        assertFalse(rewardDistribution.isRewardToken(address(rewardToken1)), "Token should not be in rewardTokens set");
    }
    ...
    function test_topUpRewards_success() public {
        ...
        assertEq(
            rewardToken1.balanceOf(address(rewardDistribution)), 500e18, "RewardDistribution should have 500e18 tokens"
        );
    }
    ...
    function test_claimReward_success() public {
        ...
        bytes32 distributionId = keccak256(abi.encodePacked(uint256(1000e18), distributionTime, block.timestamp));
        vm.stopPrank();
        ...
        assertEq(rewardToken1.balanceOf(shareholder1), 500e18, "Shareholder should have received 500e18 tokens");
    }
    ...
    function test_claimAllRewards_success() public {
        ...
        rewardDistribution.createDistribution(address(rewardToken1), 1000e18, block.timestamp + 100);
        bytes32 distributionId1 = keccak256(abi.encodePacked(uint256(1000e18), block.timestamp + 100, block.timestamp));
        rewardDistribution.createDistribution(address(rewardToken2), 2000e18, block.timestamp + 200);
        bytes32 distributionId2 = keccak256(abi.encodePacked(uint256(1000e18), block.timestamp + 200, block.timestamp));
        rewardDistribution.allocateShares(shareholder1, 500e18);
        vm.stopPrank();
        ...
        assertEq(rewardToken1.balanceOf(shareholder1), 500e18, "Shareholder should have received 500e18 RT1");
        assertEq(rewardToken2.balanceOf(shareholder1), 1000e18, "Shareholder should have received 1000e18 RT2");
    }
    ...
    function test_lockRewards_success() public {
        ...
        assertTrue(rewardDistribution.rewardsLocked(shareholder1), "Rewards should be locked for shareholder1");
    }
    ...
    function test_unlockRewards_success() public {
        ...
        assertFalse(rewardDistribution.rewardsLocked(shareholder1), "Rewards should be unlocked for shareholder1");
    }
    ...
    function test_createDistribution_success() public {
        ...
        vm.expectEmit(true, false, false, true);
        bytes32 distributionId = keccak256(abi.encodePacked(uint256(1000e18), distributionTime_1, block.timestamp));
        ...
        (address rewardToken, uint256 totalRewards, uint256 distributionTime) =
