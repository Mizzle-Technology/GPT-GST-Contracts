...
contract SalesContractPresaleTest is Test {
  ...
  function setUp() public {
    ...
    gptproxy = Upgrades.deployUUPSProxy(
      ...
      abi.encodeCall(GoldPackToken.initialize, (superAdmin, admin, sales))
    );
  ...
  function testSuccessfulPurchase() public {
    ...
    assertTrue(
      gptToken.isSales(address(salesContract)),
      'Sales role not assigned to Sales Contract'
    );
  ...
  function _getRelayerDigest(
    ISalesContract.Order memory relayerOrder
