...
contract SalesContractTest is Test {
  ...
  function setUp() public {
    ...
    vm.startPrank(sales);
    SalesContract(salesProxy).setSaleStage(ISalesContract.SaleStage.PublicSale);
    vm.stopPrank();
